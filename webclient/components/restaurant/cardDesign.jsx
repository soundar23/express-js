...
class Cards extends React.Component {
    ...
    render()
    {
        ...
        if (this.props.fav == 'fav') {
          ...
          if(this.props.comment!=''||this.state.updatebcolor=='updated'){
              but = (
                  <div>
            ...
            com = (
              <div><Card.Description><b>Comment:</b>{this.props.comment}</Card.Description></div>
            )
        }
         else {
        ...
        return (
            <Card>
                ...
                <Card.Content extra>
                    <a className="rate">
                        <Rating icon='star' defaultRating={this.props.ratings} maxRating={5} /> {this.props.ratings}/5
